...
import 'package:travel_ui/dashboard.dart';
import 'package:travel_ui/landing_page.dart';
import 'package:travel_ui/qr_page.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer2<PageOffsetNotifier, AnimationController>(
      builder: (context, notifier, animation, child) {
        return Positioned(
          left: 1 * MediaQuery.of(context).size.width - 0.85 * notifier.offset,
          bottom: 300,
  ...
  Widget build(BuildContext context) {
    return Consumer<PageOffsetNotifier>(
      ...
      child: MapHider(
        child: Center(
          child: Text(
            'Total Distance to cover 1,602 km',
            style: TextStyle(
              fontSize: 18,
          ...
          child: Center(
            child: Stack(
              ...
              children: <Widget>[
                ...
                Positioned(
                  top: top > oneThird + endTop
                      ? 0
                      : oneThird + endTop - top + 48,
                  child: Container(
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
            ...
            child: Center(
              child: Stack(
                ...
                children: <Widget>[
                  Positioned(
                    top: oneThird + 40,
                    right: width / 2 - 15 - animation.value * 60,
                    child: Container(
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        border: Border.all(color: white, width: 2.5),
                  ...
                  Positioned(
                    top: 80,
                    right: width / 2 - 4 - animation.value * 40,
                    child: Container(
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        border: Border.all(color: white, width: 2.5),
...
class YamunotriIconLabel extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer2<AnimationController, MapAnimationNotifier>(
      builder: (context, animation, notifier, child) {
        double startTop =
            topMargin(context) + mainSquareSize(context) + 32 + 16 + 32 + 4;
        double endTop = topMargin(context) + 32 + 16 + 8;
        double oneThird = (startTop - endTop) / 2.5;
        double opacity;
...
class GangotriIconLabel extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer2<AnimationController, MapAnimationNotifier>(
      builder: (context, animation, notifier, child) {
        double startTop =
            topMargin(context) + mainSquareSize(context) + 32 + 16 + 32 + 4;
        double endTop = topMargin(context) + 32 + 16 + 8;
        double oneThird = (startTop - endTop) / 3.6;
        double opacity;
        if (animation.value < 2 / 3) {
          opacity = 0;
        } else if (notifier.value == 0) {
...
class MapGangotri extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer<MapAnimationNotifier>(
      builder: (context, notifier, child) {
        ...
        return Positioned(
          right: 100,
          top: topMargin(context) + 70 + 4 + oneThird(context),
          child: Opacity(
            opacity: opacity,
            child: child,
          ),
...
class MapBadrinath extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer<MapAnimationNotifier>(
      builder: (context, notifier, child) {
...
class MapKedarnath extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer<MapAnimationNotifier>(
      builder: (context, notifier, child) {
...
class MapYamunotri extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer<MapAnimationNotifier>(
      builder: (context, notifier, child) {
...
class BadrinathIconLabel extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer2<AnimationController, MapAnimationNotifier>(
      builder: (context, animation, notifier, child) {
        ...
        return Positioned(
          top: endTop(context) + oneThird(context),
          left: 10 + opacity * 16,
          child: Opacity(
            opacity: opacity,
            child: child,
...
class KedarnathIconLabel extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer2<AnimationController, MapAnimationNotifier>(
      builder: (context, animation, notifier, child) {
...
class SmallAnimalIconLabel extends StatelessWidget {
  ...
  const SmallAnimalIconLabel(
      {Key? key, required this.name, required this.showLine})
      : super(key: key);
